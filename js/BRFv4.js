...
var brfv4BaseURL = _isWebAssemblySupported ? "brf_wasm/" : "brf_asmjs/";
...
function initExample() {
  ...
  var webcam        = document.getElementById("webcam");     // our webcam video
  var imageData     = new OffscreenCanvas(webcam.videoWidth, webcam.videoHeight);  // image data for BRFv4
